package com.pugz.omni.client.model;
...
public class BambooSpearModel extends Model {
        public static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("omni", "textures/entity/paradise/bamboo_spear.png");
