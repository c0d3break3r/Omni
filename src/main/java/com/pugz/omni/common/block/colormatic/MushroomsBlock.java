...
public class MushroomsBlock extends BushBlock implements IGrowable, IStackable {
    private static final VoxelShape MULTI_MUSHROOM_SHAPE = Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 9.0D, 12.0D);
    ...
    public MushroomsBlock(Properties properties, Block base, Supplier<ConfiguredFeature<?, ?>> mushroomsFeature) {
        ...
        setDefaultState(this.stateContainer.getBaseState().with(MUSHROOMS, 2));
    }
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        return state.get(MUSHROOMS) == 2 ? base.getShape(state, worldIn, pos, context) : MULTI_MUSHROOM_SHAPE;
    }
    ...
    public void removeOne(World world, BlockPos pos, BlockState state) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            default:
                world.setBlockState(pos, state.with(MUSHROOMS, i - 1), 3);
    ...
    public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
        this.mushroomsFeature.get().generate(worldIn, worldIn.getChunkProvider().getChunkGenerator(), rand, pos);
    }
