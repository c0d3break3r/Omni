package com.pugz.omni.common.entity.paradise;
...
public class BambooSpearEntity extends AbstractArrowEntity {
    ...
    public BambooSpearEntity(EntityType<? extends BambooSpearEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public BambooSpearEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
    ...
    @OnlyIn(Dist.CLIENT)
    public BambooSpearEntity(World worldIn, double x, double y, double z) {
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        if (compound.contains("Bamboo_Spear", 10)) {
            this.thrownStack = ItemStack.read(compound.getCompound("Bamboo_Spear"));
        }
    ...
    public void writeAdditional(CompoundNBT compound) {
        ...
        compound.put("Bamboo_Spear", this.thrownStack.write(new CompoundNBT()));
