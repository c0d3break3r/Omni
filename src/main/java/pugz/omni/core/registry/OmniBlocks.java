...
public class OmniBlocks {
    ...
    public static RegistryObject<Block> YELLOW_CAVE_MUSHROOM_BLOCK;
    public static RegistryObject<Block> GREEN_CAVE_MUSHROOM_BLOCK;
    public static RegistryObject<Block> BLUE_CAVE_MUSHROOM_BLOCK;
    ...
    public static RegistryObject<Block> CAVE_MUSHROOM_HYPHAE;
    public static RegistryObject<Block> STRIPPED_CAVE_MUSHROOM_HYPHAE;
    ...
    public static RegistryObject<Block> CAVE_MUSHROOM_FENCE;
    ...
    public static RegistryObject<Block> CAVE_MUSHROOM_LADDER;
    ...
    public static RegistryObject<Block> CAVE_MUSHROOM_SIGN;
    public static RegistryObject<Block> CAVE_MUSHROOM_WALL_SIGN;
    ...
    //miscellaneous
    public static RegistryObject<Block> VEXED_GLASS;
    ...
    public static RegistryObject<Block> ACAI_TRAPPED_CHEST;
    public static RegistryObject<Block> ACAI_SIGN;
    public static RegistryObject<Block> ACAI_WALL_SIGN;
    ...
    public static RegistryObject<Block> CACTUS_BLOOM;
