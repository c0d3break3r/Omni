...
import pugz.omni.common.world.feature.cavier_caves.SmallMushroomFeatureConfig;
...
public class OmniFeatures {
    ...
    public static RegistryObject<Feature<SmallMushroomFeatureConfig>> SMALL_MUSHROOM;
}