...
public class CompatReferences {
    ...
    public static Block YUCCA_FLOWER;
    ...
    public static void initializeReferences() {
        ...
        WHITE_CLOVER = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("buzzier_bees", "violet"));
        WHITE_LOTUS_FLOWER = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("environmental", "violet"));
        YELLOW_HIBISCUS = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("environmental", "violet"));
        YUCCA_FLOWER = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("atmospheric", "yucca_flower"));
    }
}