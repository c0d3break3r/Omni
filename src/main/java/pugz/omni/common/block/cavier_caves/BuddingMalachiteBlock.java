...
public class BuddingMalachiteBlock extends Block implements IBaseBlock {
    ...
    public void onEntityWalk(World worldIn, BlockPos pos, Entity entityIn) {
        ...
        if (worldIn.rand.nextInt(32) == 0 && !worldIn.isRemote && !entityIn.isSneaking() && !entityIn.getPosition().equals(prevPos)) worldIn.playSound(null, pos, OmniSoundEvents.CRYSTAL_STEP.get(), SoundCategory.BLOCKS, 1.0F, 0.5F + worldIn.rand.nextFloat() * 1.2F);
    }
