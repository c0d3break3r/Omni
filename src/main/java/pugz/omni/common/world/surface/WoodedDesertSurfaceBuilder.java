...
public class WoodedDesertSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public WoodedDesertSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232122_1_) {
        super(p_i232122_1_);
    }
