        ...
        if (this.isAlive()) {
            if (this.isBeingRidden() && this.canBeSteered() && this.isInWater()) {
                ...
                if (this.canPassengerSteer()) {
                    ...
                    this.setAIMoveSpeed((float)this.getAttributeValue(Attributes.MOVEMENT_SPEED) * (float)this.getAttributeValue(Attributes.MOVEMENT_SPEED) * 1.05F);
                    ...
                    this.setMotion(this.getMotion().scale(this.getAttributeValue(Attributes.MOVEMENT_SPEED) * 1.05F));
